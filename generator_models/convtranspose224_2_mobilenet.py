...
def return_generator_model_and_imgsize(latent_dim=512):
    ...
    s = (2,2)
    f = 250
    model.add(Dense(120 * t * t, activation="relu", input_dim=latent_dim))
    model.add(Reshape((t, t, 120)))
    ...
    model.add(Conv2DTranspose(3, kernel_size=10, strides=s, activation='linear'))
