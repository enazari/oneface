...
def return_generator_model_and_imgsize(latent_dim=1024):
    ...
    model.add(Conv2DTranspose(200, kernel_size=16, strides=(2, 2), activation='relu'))
    model.add(BatchNormalization(momentum=0.8))

    model.add(Conv2DTranspose(200, kernel_size=10, strides=(2, 2), activation='relu'))
    model.add(BatchNormalization(momentum=0.8))

    model.add(Conv2DTranspose(200, kernel_size=6, strides=(2, 2), activation='relu'))
    model.add(BatchNormalization(momentum=0.8))
