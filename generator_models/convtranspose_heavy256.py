...
def return_generator_model_and_imgsize(latent_dim=1024):
    ...
    model.add(Conv2DTranspose(128, kernel_size=10, strides=(2, 2), activation='relu'))
    model.add(BatchNormalization(momentum=0.8))

    model.add(Conv2DTranspose(128, kernel_size=15, strides=(2, 2), activation='relu'))
    model.add(BatchNormalization(momentum=0.8))

    model.add(Conv2DTranspose(128, kernel_size=20, strides=(2, 2), activation='relu'))
    model.add(BatchNormalization(momentum=0.8))

    model.add(Conv2DTranspose(3, kernel_size=58, strides=(2, 2), activation='linear'))
    model.add(BatchNormalization(momentum=0.8))
